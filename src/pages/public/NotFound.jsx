    ...
    <div className="relative min-h-[70vh] flex items-center justify-center overflow-hidden px-4 sm:px-6 py-24">
      ...
      >
        <div className="flex justify-center mb-6">
          <BrandMark size={44} variant={logoVariant} />
        </div>
        <span className="block text-xs font-semibold uppercase tracking-[0.22em] text-primary-600 dark:text-primary-300 mb-3">
          Error 404
        </span>
        ...
        <div className="flex flex-wrap items-center justify-center gap-3">
          ...
          <Link to="/reservar">
            <Button variant="outline" size="md" className="gap-2">
              <CalendarCheck size={16} /> Reservar hora
            </Button>
          </Link>
        </div>
      </motion.div>
